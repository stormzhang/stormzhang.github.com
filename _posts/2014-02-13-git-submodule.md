...
开发过程中经常用到的Git操作在这篇博客[Git常用命令备忘](http://stormzhang.github.io/git/2014/01/27/git-common-command/)有介绍，但是没有涉及到submodule的命令，这也是比较常用的命令，这篇博客就介绍下git submodule的用法.
